...
import { Facebook, Instagram, Twitter, Youtube, Linkedin, Video, Mail, Phone, MapPin, Navigation } from 'lucide-react';
...
export default function Footer() {
  ...
  const googleMapsUrl = `https://www.google.com/maps/dir/?api=1&destination=${schoolCoordinates.lat},${schoolCoordinates.lng}`;
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <a 
                  href="mailto:stmichaelschool23@gmail.com" 
                  className="flex items-center gap-2 hover:text-primary-400 transition-colors"
                >
            ...
            <div className="mt-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-primary-600 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-primary-700 transition-colors shadow-lg hover:shadow-xl"
              >
